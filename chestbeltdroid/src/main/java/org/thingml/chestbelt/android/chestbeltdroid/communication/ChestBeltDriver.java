...
public class ChestBeltDriver implements Runnable {

	private static final String TAG = ChestBeltDriver.class.getSimpleName();
    ...
    public ChestBeltDriver(InputStream in, OutputStream out) {
    	this.in = in;
        this.out = out;
    ...
    public void run() {
            ...
            while ((len = this.in.read(buffer)) > -1) {
                ...
                for (int i = 0; i < len; i++) {
                    ...
                    if (c > 95) {
                        ...
                        if (msg_index != 0) {
                            Log.w(TAG, "ChestBelt: Received incomplete message (code = " + code + ").");
                        }
                        ...
                        if (msg_index > 0 && msg_index < target_length) {
                            ...
                            if (msg_index == target_length) {
                                ...
                                switch (code) {
                                    ...
                                    case 120:
                                        ...
                                        break;
                                    default:
                                        //Log.w(TAG, "ChestBelt: Received unknown message (code = " + code + ").");
                                }
                            ...
                            Log.w(TAG, "ChestBelt: Received Corrupted Data.");
                        }
                    }
                }
            }
        ...
        Log.w(TAG, "ChestBelt: Receiver thread stopped.");
    }
    ...
    synchronized void cUFWRevision(byte[] message) {
        ...
        int timestamp = ((message[4] - 32) * 64 + (message[5] - 32));
        for (ChestBeltListener l : listeners) {
            l.cUFWRevision(value, timestamp);
        }
    }
